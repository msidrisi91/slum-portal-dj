...
def test_on_file(model, img):
	...
	visualize.save_instances(image, results['rois'], results['masks'], results['class_ids'], 
							 class_names,'/media/shaheem/Data/Projects/PycharmProjects/djangoProject/templates/assets/results/pred.jpg',results['scores'], ax=None,
...
if __name__ == '__main__':
	...
	test_on_file(model, 'test_images/img.jpg')
